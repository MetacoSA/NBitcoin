...
namespace NBitcoin.BouncyCastle.Crypto.Digests
{
    ...
    /// sizes, based on the <see cref="NBitcoin.BouncyCastle.Crypto.Engines.ThreefishEngine">Threefish</see> tweakable block cipher.
    /// </summary>
    /// <remarks>
    ...
    /// <p/>
    /// This implementation is the basis for <see cref="NBitcoin.BouncyCastle.Crypto.Digests.SkeinDigest"/> and <see cref="NBitcoin.BouncyCastle.Crypto.Macs.SkeinMac"/>, implementing the
    /// parameter based configuration system that allows Skein to be adapted to multiple applications. <br/>
    /// Initialising the engine with <see cref="NBitcoin.BouncyCastle.Crypto.Parameters.SkeinParameters"/> allows standard and arbitrary parameters to
        ...
        : IMemoable
    {
        ...
        /// <summary>
        /// Initialises the Skein engine with the provided parameters. See <see cref="NBitcoin.BouncyCastle.Crypto.Parameters.SkeinParameters"/> for
