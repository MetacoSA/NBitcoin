...
namespace NBitcoin.Tests
{
	public class PSBTTests
	{
		...
		public void CanFollowBIPExample()
		{
			...
			// Public Keys
			actualPsbt.AddKeyPath(extkey.ExtKey.PrivateKey.PubKey.GetHDFingerPrint(), new PubKey("029583bf39ae0a609747ad199addd634fa6108559d6c5cd39b4c2183f1ab96e07f"), new KeyPath("m/0'/0'/0'"));
			actualPsbt.AddKeyPath(extkey.ExtKey.PrivateKey.PubKey.GetHDFingerPrint(), new PubKey("02dab61ff49a14db6a7d02b0cd1fbb78fc4b18312b5b4e54dae4dba2fbfef536d7"), new KeyPath("m/0'/0'/1'"));
			actualPsbt.AddKeyPath(extkey.ExtKey.PrivateKey.PubKey.GetHDFingerPrint(), new PubKey("03089dc10c7ac6db54f91329af617333db388cead0c231f723379d1b99030b02dc"), new KeyPath("m/0'/0'/2'"));
			actualPsbt.AddKeyPath(extkey.ExtKey.PrivateKey.PubKey.GetHDFingerPrint(), new PubKey("023add904f3d6dcf59ddb906b0dee23529b7ffb9ed50e5e86151926860221f0e73"), new KeyPath("m/0'/0'/3'"));
			actualPsbt.AddKeyPath(extkey.ExtKey.PrivateKey.PubKey.GetHDFingerPrint(), new PubKey("03a9a4c37f5996d3aa25dbac6b570af0650394492942460b354753ed9eeca58771"), new KeyPath("m/0'/0'/4'"));
			actualPsbt.AddKeyPath(extkey.ExtKey.PrivateKey.PubKey.GetHDFingerPrint(), new PubKey("027f6399757d2eff55a136ad02c684b1838b6556e5f1b6b34282a94b6b50051096"), new KeyPath("m/0'/0'/5'"));
			...
			actualPsbt.SignAll(extkey, new KeyPath("m/0'/0'/0'"));
			actualPsbt.SignAll(extkey, new KeyPath("m/0'/0'/2'"));
			Assert.Equal(expectedPsbt, actualPsbt);

			actualPsbt = tmp.Clone();
			actualPsbt.SignAll(new BitcoinSecret("cP53pDbR5WtAD8dYAW9hhTjuvvTVaEiQBdrz9XPrgLBeRFiyCbQr", Network.TestNet));
			actualPsbt.SignAll(new BitcoinSecret("cR6SXDoyfQrcp4piaiHE97Rsgta9mNhGTen9XeonVgwsh4iSgw6d", Network.TestNet));
			...
			actualPsbt.SignAll(new BitcoinSecret("cT7J9YpCwY3AVRFSjN6ukeEeWY6mhpbJPxRaDaP5QTdygQRxP9Au", Network.TestNet));
			actualPsbt.SignAll(new BitcoinSecret("cNBc3SWUip9PPm1GjRoLEJT6T41iNzCYtD7qro84FMnM5zEqeJsE", Network.TestNet));
