...
namespace NBitcoin.Tests
{
	...
	public class Blech32Test
	{
		...
		public void ValidateValidChecksum()
		{
			...
			{
				var bech = Blech32Encoder.ExtractEncoderFromString(test);
		...
		Blech32Encoder bech32 = Encoders.Blech32("bc");
		Blech32Encoder tbech32 = Encoders.Blech32("tb");
		[Fact]
