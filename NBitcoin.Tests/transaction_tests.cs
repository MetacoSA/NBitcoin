...
namespace NBitcoin.Tests
{
	public class transaction_tests
	{
		...
		{
			var allowLowS = ScriptVerify.Standard & ~ScriptVerify.LowS;
			...
			AssertCorrectlySigned(partiallySigned, fundingTransaction.Outputs[0].ScriptPubKey, allowLowS);
			...
			AssertCorrectlySigned(gistTransaction, fundingTransaction.Outputs[0].ScriptPubKey, allowLowS); //One sig in the hard code tx is high
