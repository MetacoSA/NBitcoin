...
namespace NBitcoin.Tests
{
	public class NodeBuilderEx
	{
		public static NodeBuilder Create([CallerMemberName] string caller = null)
		{
			...
			//var builder = NodeBuilder.Create(NodeDownloadData.Groestlcoin.v2_20_1, Altcoins.AltNetworkSets.Groestlcoin.Regtest, caller);
			...
			//var builder = NodeBuilder.Create(NodeDownloadData.Bitcore.v0_90_9_5, Altcoins.Bitcore.Instance.Regtest, caller);
