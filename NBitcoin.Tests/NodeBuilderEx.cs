...
namespace NBitcoin.Tests
{
	public class NodeBuilderEx
	{
		public static NodeBuilder Create([CallerMemberName] string caller = null)
		{
			...
			//var builder = NodeBuilder.Create(NodeDownloadData.Pepecoin.v1_1_0, Altcoins.Pepecoin.Instance.Regtest, caller);
			...
			//var builder = NodeBuilder.Create(NodeDownloadData.Elements.v22_1_1, Altcoins.AltNetworkSets.Liquid.Regtest, caller);
