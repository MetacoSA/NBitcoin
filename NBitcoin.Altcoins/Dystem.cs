...
#pragma warning restore CS0618 // Type or member is obsolete
		...
		private static Network mainnetReg()
		{
			...
			var res = builder.SetConsensus(new Consensus()
			{
				...
				ConsensusFactory = new DystemConsensusFactory(),
				SupportSegwit = false
			})
			...
			.AddDNSSeeds(new[]
			{
				new DNSSeedData("Dystem.org", "dnsseed.Dystem.org"),
				new DNSSeedData("Dystemdot.io", "dnsseed.Dystemdot.io"),
				new DNSSeedData("masternode.io", "dnsseed.masternode.io"),
				new DNSSeedData("Dystempay.io", "dnsseed.Dystempay.io")
			})
		...
		private static void registerDefaultCookiePath(Network network, params string[] subfolders)
		{
			...
			{
				var pathList = new List<string> { home, ".Dystem" };
			...
			{
				var pathList = new List<string> { localAppData, "Dystem" };
				pathList.AddRange(subfolders);
