	...
	public class Liquid : NetworkSetBase
	{
		...
		protected override NetworkBuilder CreateMainnet()
		{
			...
			builder.SetConsensus(new Consensus()
			{
				...
				ConsensusFactory = new ElementsConsensusFactory<Liquid>()
			})
			...
			.SetBech32(Bech32Type.BLINDED_ADDRESS, NBitcoin.Altcoins.Elements.Encoders.Blech32("lq"))
			.SetMagic(0xdab5bffa)
			.SetPort(7042)
			.SetRPCPort(7041)
			.SetName("liquid")
		...
		protected override NetworkBuilder CreateRegtest()
		{
			...
			builder.SetConsensus(new Consensus()
			{
				...
				ConsensusFactory = new ElementsConsensusFactory<LiquidRegtest>()
			})
			.SetNetworkStringParser(new ElementsStringParser())
			...
			.SetBech32(Bech32Type.BLINDED_ADDRESS, NBitcoin.Altcoins.Elements.Encoders.Blech32("el"))
			.SetMagic(0xdab5bffa)
			.SetPort(19444)
			.SetRPCPort(19332)
			.SetName("liq-reg")
