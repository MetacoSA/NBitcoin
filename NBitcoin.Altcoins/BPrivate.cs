...
{
	// Reference:
	// https://github.com/BTCPrivate/BitcoinPrivate/blob/master/src/chainparams.cpp
	// https://github.com/BTCPrivate/BTCP-Rebase/blob/master/src/chainparams.cpp
	public class BPrivate : NetworkSetBase
	{
		public static BPrivate Instance { get; } = new BPrivate();

		public override string CryptoCode => "BTCP";
		...
		public class BitcoinPrivateConsensusFactory : ConsensusFactory
		{
			private BitcoinPrivateConsensusFactory()
			{
			}

			public static BitcoinPrivateConsensusFactory Instance { get; } = new BitcoinPrivateConsensusFactory();

			public override BlockHeader CreateBlockHeader()
			{
				return new BitcoinPrivateBlockHeader();
			}
			public override Block CreateBlock()
			{
				return new BitcoinPrivateBlock(new BitcoinPrivateBlockHeader());
			}
...
#pragma warning disable CS0618 // Type or member is obsolete
		public class BitcoinPrivateBlock : Block
		{
			public BitcoinPrivateBlock(BitcoinPrivateBlockHeader header) : base(header)
			{
			...
			{
				return BitcoinPrivateConsensusFactory.Instance;
			}
		}
...
#pragma warning restore CS0618 // Type or member is obsolete
		...
		{
			RegisterDefaultCookiePath("btcprivate");
		}
		...
		protected override NetworkBuilder CreateTestnet()
		{
			...
			.SetBech32(Bech32Type.WITNESS_PUBKEY_ADDRESS, Encoders.Bech32("tbtcp"))
			.SetBech32(Bech32Type.WITNESS_SCRIPT_ADDRESS, Encoders.Bech32("tbtcp"))
			.SetMagic(0xf61bf6d6)
			.SetPort(17933)
			.SetRPCPort(17932)
			.SetMaxP2PVersion(180004)
			.SetName("btcp-test")
			.AddAlias("btcp-testnet")
			.AddAlias("BitcoinPrivate-test")
			.AddAlias("BitcoinPrivate-testnet")
			.AddDNSSeeds(new[]
			{
				new DNSSeedData("dnsseed.testnet.btcprivate.org", "dnsseed.testnet.btcprivate.org")
			})
			.AddSeeds(new NetworkAddress[0])
		...
		protected override NetworkBuilder CreateRegtest()
		{
			...
			.SetBase58Bytes(Base58Type.EXT_PUBLIC_KEY, new byte[] { 0x04, 0x35, 0x87, 0xCF })
			.SetBase58Bytes(Base58Type.EXT_SECRET_KEY, new byte[] { 0x04, 0x35, 0x83, 0x94 })
			.SetBech32(Bech32Type.WITNESS_PUBKEY_ADDRESS, Encoders.Bech32("regbtcp"))
			.SetBech32(Bech32Type.WITNESS_SCRIPT_ADDRESS, Encoders.Bech32("regbtcp"))
			.SetMagic(0xaae83f5f)
			.SetPort(17944)
			.SetRPCPort(17944)
			.SetMaxP2PVersion(180004)
			.SetName("btcp-reg")
			.AddAlias("btcp-regtest")
			.AddAlias("BitcoinPrivate-reg")
			.AddAlias("BitcoinPrivate-regtest")
