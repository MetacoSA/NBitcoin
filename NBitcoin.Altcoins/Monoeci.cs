...
{
	// Reference: https://github.com/monacocoin-net/monoeci-core/blob/v0.12.2.3/src/chainparams.cpp
...
#pragma warning disable CS0618 // Type or member is obsolete
		public class MonoeciBlockHeader : BlockHeader
		{
			...
			// https://github.com/monacocoin-net/monoeci-core/blob/v0.12.2.3/src/primitives/block.cpp#L15
...
#pragma warning restore CS0618 // Type or member is obsolete
		...
		protected override NetworkBuilder CreateMainnet()
		{
			...
			builder.SetConsensus(new Consensus()
			{
				...
				MinimumChainWork = new uint256("0x0000000000000000000000000000000000000000000000072eb013e4e8b5407f"),
			...
			.SetBase58Bytes(Base58Type.SCRIPT_ADDRESS, new byte[] { 73 })
			.SetBase58Bytes(Base58Type.SECRET_KEY, new byte[] { 77 })
			...
			.AddDNSSeeds(new[]
			{
				...
				new DNSSeedData("block.monoeci.io", "block.monoeci.iom")
			})
		...
		protected override NetworkBuilder CreateTestnet()
		{
		   ...
		   .AddDNSSeeds(new[]
		   {
				new DNSSeedData("testnet1.monoeci.io",  "testnet1.monoeci.io"),
				new DNSSeedData("testnet2.monoeci.io", "testnet2.monoeci.io")
		   })
		   .AddSeeds(new NetworkAddress[0])
