...
namespace NBitcoin.Altcoins.HashX11.Crypto.SHA3.Custom
{
    ...
    internal abstract class SHAvite3Base : BlockHash, ICryptoNotBuildIn
    {
        ...
        public SHAvite3Base(NBitcoin.Altcoins.HashX11.HashSize a_hash_size, int a_block_size)
    ...
    //    public SHAvite3_256Base(NBitcoin.Altcoins.HashX11.HashSize a_hash_size)
    //        : base(a_hash_size, 64)
    //    {
    //        Initialize();
    //    }
    ...
    internal abstract class SHAvite3_512Base : SHAvite3Base
    {
        ...
        public SHAvite3_512Base(NBitcoin.Altcoins.HashX11.HashSize a_hash_size)
