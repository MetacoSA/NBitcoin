...
C:\Windows\Microsoft.NET\Framework\v4.0.30319\msbuild.exe "..\NBitcoin.Portable\NBitcoin.Portable(portable-net45+netcore45+wpa81+wp8+MonoAndroid1+MonoTouch1).csproj" -p:Configuration=Release
