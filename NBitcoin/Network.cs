		...
		uint[] pnSeed = new uint[]
{
    ...
    0x13f5094c, 0x7ab32648, 0x542e9fd5, 0x53136bc1, 0x7fdf51c0, 0x802197b2, 0xa2d2cc5b, 0x6b5f4bc0,
		...
		private void InitMain()
		{
			...
			txNew.VOut[0].ScriptPubKey = new Script() + DataEncoders.Encoders.Hex.DecodeData("04678afdb0fe5548271967f1a67130b7105cd6a828e03909a67962e0ea1f61deb649f6bc3f4cef38c4f35504e51ec112de5c384df7ba0b8d578a4c702b6bf11d5f") + OpcodeType.OP_CHECKSIG;
			genesis.Vtx = genesis.Vtx.Concat(new[] { txNew }).ToArray();
			genesis.Header.HashPrevBlock = 0;
			genesis.Header.HashMerkleRoot = genesis.BuildMerkleTree();
