...
{
	public class WalletPolicyFormatException : FormatException
	{
		public WalletPolicyFormatException(string message) : base(message)
		{
		}
	}
	...
	public class WalletPolicy
	{
		...
		public static WalletPolicy Parse(string str, Network network)
		{
			...
			{
				throw new WalletPolicyFormatException(e.Message);
			}
		}
